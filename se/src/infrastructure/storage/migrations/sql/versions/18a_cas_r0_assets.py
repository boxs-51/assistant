...
Revision ID: 18a_cas_r0_assets
Revises: 17a_r11_checkpoint_cutover

This CAS-R0 convergence migration preserves the historical F1 expand-only
schema on the current Agent/R11 migration lineage. It intentionally does not
backfill or drop the legacy attachments table. Object-store I/O is forbidden
inside Alembic.
"""
...
revision: str = "18a_cas_r0_assets"
